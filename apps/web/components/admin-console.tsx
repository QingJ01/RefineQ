...
const operationsCopy = {
  zh: {
    ...
    confirmDescription: "服务端会完整解压并校验备份，但不会覆盖当前运行数据。无需手动输入口令，系统会自动提交与该备份 ID 绑定的确认指令：",
    confirm: "确认并校验",
    cancel: "取消",
  ...
  en: {
    ...
    confirmDescription: "The server will fully extract and verify this backup without overwriting live data. No passphrase is required; the confirmation bound to this backup ID is submitted automatically:",
